...
func InitOptionMap() {
	...
	common.OptionMap["ReferralTopUpThresholdUSD"] = strconv.Itoa(common.ReferralTopUpThresholdUSD)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "ReferralTopUpThresholdUSD":
		common.ReferralTopUpThresholdUSD, _ = strconv.Atoi(value)
