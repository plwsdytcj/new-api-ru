...
var publicSEOPages = map[string]seoPage{
	"/": {
		...
		Description: "RussiaAPI — единый API нейросетей для разработчиков в России. Сейчас доступны девять текстовых и графических GPT-моделей; новые международные и китайские поставщики добавляются поэтапно.",
		...
		Details: []seoDetail{
			...
			},
			{
				...
				Summary: "Сейчас доступны девять текстовых и графических GPT-моделей. Новые международные и китайские поставщики появляются в каталоге только после запуска и проверки каналов.",
			},
		},
	},
	"/pricing": {
