...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/billing-policy", controller.GetBillingPolicy)
		apiRouter.GET("/company-details", controller.GetCompanyDetails)
		apiRouter.GET("/receipt-policy", controller.GetReceiptPolicy)
